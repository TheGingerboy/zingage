    ...
    <section>
      ...
      <div class="row margin">
        ...
        <div class="col-sm-4">
          ...
          <section class="section col-sm-12">
            ...
            <a href="/zingage/ficheProduit/<?php echo $new1['id_article'] ?>">
              <div class="blanc">
                <img src="/zingage/web/images/article/<?php echo $new1['img_article'] ?>" alt="<?php echo $new1['nom_article']?>">
          ...
          <section class="section col-sm-12">
            ...
            <a href="/zingage/ficheProduit/<?php echo $new2['id_article'] ?>">
              <div class="blanc">
                <img src="/zingage/web/images/article/<?php echo $new2['img_article'] ?>" alt="<?php echo $new2['nom_article']?>">
        ...
        <section class="section innovation col-sm-5">
          ...
          <div class ="blanc">
            <?php
                ...
                <a href="/zingage/ficheProduit/<?php echo $article['id_article'] ?>">
                    <img src="/zingage/web/images/article/<?php echo $article['img_article'] ?>" alt="<?php echo $article['nom_article'] ?>"/>
      ...
      <div class="row categories">
        ...
        <section class="col-sm-5">
          <a href="/zingage/entretien">
            <h2>Entretien jardin</h2>
            <img src="/zingage/web/images/entretienJardin.jpg" alt="illustration entretien jardin">
          </a>
        </section>

        <section class="col-sm-5">
          <a href="/zingage/detente">
            <h2>Détente et loisirs</h2>
            <img src="/zingage/web/images/detenteJardin.jpg" alt="illustration detente et loisirs">
          </a>
        </section>
