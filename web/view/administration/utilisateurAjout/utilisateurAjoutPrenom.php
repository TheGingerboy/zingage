...
<div id="formulaire">
    ...
    <form id="ajout-user-form" action="<?php echo "http://" . $_SERVER['SERVER_NAME'] . "/zingage/administration/utilisateurs/ajout/mdp1" ?>" method="post" autocomplete="off">

		<div class="form-group">
			<h3 class="center">Entrez le Prénom</h3>
	        <label for="prenom_utilisateur">Prenom <span class="asterix">*</span> : </label>
	        <input id="prenom-input" name="prenom_utilisateur" class="form-control" autocomplete="off" required="required">
    </div>
