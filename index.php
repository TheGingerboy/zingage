...
*/
    ...
    $app->post('/profil/info/traitement', function(){
        $logo_page =  "/zingage";
        $logo_img = "logo-green.png";
        $page_color = '#96c11f';
        $arrow_return = '/zingage';
        $content =  substr((require_once '/web/view/header.php'), 0, -1);
        $content .= substr((require_once '/web/model/connexionBD.php'), 0, -1);
        $content .= substr((require_once '/web/model/profilInfoEditionTraitement.php'), 0, -1);
        $content .= substr((require_once '/web/view/footer.php'), 0, -1);
        return $content;
    });

    $app->post('/profil/mdp1', function(){
        $hide_logo_page  = true;
        $hide_conect_btn = true;
        $arrow_return    = true;
        $logo_page =  "/zingage";
        ...
        $content =  substr((require_once '/web/view/header.php'), 0, -1);
        $content .= substr((require_once '/web/model/connexionBD.php'), 0, -1);
        $content .= substr((require_once '/web/view/profilEdit/profilEditMdp1.php'), 0, -1);
        $content .= substr((require_once '/web/view/footer.php'), 0, -1);
        return $content;
    });

    $app->post('/profil/mdp2', function(){
        $hide_logo_page  = true;
        $hide_conect_btn = true;
        $arrow_return    = true;
        $logo_page =  "/zingage";
        ...
        $page_color = '#96c11f';
        $content =  substr((require_once '/web/view/header.php'), 0, -1);
        $content .= substr((require_once '/web/view/profilEdit/profilEditMdp2.php'), 0, -1);
        $content .= substr((require_once '/web/view/footer.php'), 0, -1);
        return $content;
    });

    $app->post('/profil/mdp/traitement', function(){
        $logo_page =  "/zingage";
        $logo_img = "logo-green.png";
        $page_color = '#96c11f';
        $arrow_return = '/zingage';
        $content =  substr((require_once '/web/view/header.php'), 0, -1);
        $content .= substr((require_once '/web/model/connexionBD.php'), 0, -1);
        $content .= substr((require_once '/web/model/profilMdpEditionTraitement.php'), 0, -1);
        $content .= substr((require_once '/web/view/footer.php'), 0, -1);
        return $content;
    });
